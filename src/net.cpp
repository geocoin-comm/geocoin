...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Geocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"188.134.75.41", "94.19.244.216"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"104.236.52.122", "104.236.52.122"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Geocoin is probably already running."), addrBind.ToString().c_str());
        else
